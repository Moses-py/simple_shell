...
/**
 *change_directory - implement the cd command
 *@num_args: num of arguments
...
{
	char *new_working_directory = NULL, *dir = NULL;
	char *cur_working_directory = NULL, *old_working_directory = getenv("OLDPWD");
